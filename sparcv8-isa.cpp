...
//Definitions related to PSR register
bool PSR_icc_n = 0;
bool PSR_icc_z = 0;
bool PSR_icc_v = 0;
bool PSR_icc_c = 0;
...
inline void update_pc(bool branch, bool taken, bool b_always, bool annul, ac_word addr)
{
...
#define update_pc(a,b,c,d,e) /*nothing*/
#endif
...
void ac_behavior( call )
{
  ...
  update_pc(1,1,1,0, ac_pc+(disp30<<2));
};
...
{
  dbg_printf("ba 0x%x\n", ac_pc+(disp22<<2));
  update_pc(1,1,1,an, ac_pc+(disp22<<2));
};
...
{
  dbg_printf("bne 0x%x\n", ac_pc+(disp22<<2));
  update_pc(1, !PSR_icc_z, 0, an, ac_pc+(disp22<<2));
};
...
{
  dbg_printf("bg 0x%x\n", ac_pc+(disp22<<2));
  update_pc(1, !(PSR_icc_z ||(PSR_icc_n ^PSR_icc_v)), 0, an, ac_pc+(disp22<<2));
};
...
{
  dbg_printf("bge 0x%x\n", ac_pc+(disp22<<2));
  update_pc(1, !(PSR_icc_n ^PSR_icc_v), 0, an, ac_pc+(disp22<<2));
};
...
{
  dbg_printf("bgu 0x%x\n", ac_pc+(disp22<<2));
  update_pc(1, !(PSR_icc_c ||PSR_icc_z), 0, an, ac_pc+(disp22<<2));
};
...
{
  dbg_printf("bcc 0x%x\n", ac_pc+(disp22<<2));
  update_pc(1, !PSR_icc_c, 0, an, ac_pc+(disp22<<2));
};
...
void ac_behavior( bpos )
{
  ...
  update_pc(1, !PSR_icc_n, 0, an, ac_pc+(disp22<<2));
};
...
{
  dbg_printf("bvc 0x%x\n", ac_pc+(disp22<<2));
  update_pc(1, !PSR_icc_v, 0, an, ac_pc+(disp22<<2));
};
...
void ac_behavior( jmpl_reg )
{
  ...
  update_pc(1,1,1,0, readReg(rs1) + readReg(rs2));
};
...
void ac_behavior( jmpl_imm )
{
  ...
  writeReg(rd, ac_pc);
  update_pc(1,1,1,0, readReg(rs1) + simm13);
};
